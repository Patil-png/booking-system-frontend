...
//       } catch (err) {
//         console.error(err);
//         setStatusMessage('❌ Online booking failed.');
//       }
//     }
//   };
...
//       <h2 className="text-2xl font-bold text-center mb-6">Admin Lawn Booking</h2>

//       <div className="mb-4">
//         <label className="font-semibold mr-2">Booking Type:</label>
//         <select value={bookingType} onChange={e => setBookingType(e.target.value)} className="border rounded px-3 py-2">
//           <option value="slot">Slot Booking</option>
//           <option value="perPlate">Per Plate Booking</option>
//         </select>
//       </div>
...
//           <select name="slot" value={formData.slot} onChange={handleChange} className="w-full border px-3 py-2 rounded">
...
//             <input type="number" name="plates" value={formData.plates} onChange={handleChange} className="w-full border px-3 py-2 rounded" />
//           </div>
//           <div className="mb-4">
//             <label>Price per Plate (₹):</label>
//             <input type="number" name="pricePerPlate" value={formData.pricePerPlate} onChange={handleChange} className="w-full border px-3 py-2 rounded" />
//           </div>
//         </>
//       )}
...
//         <input type="date" name="checkIn" value={formData.checkIn} onChange={handleChange} className="w-full border px-3 py-2 rounded" />
//       </div>
//       <div className="mb-4">
//         <label>Check-Out Date:</label>
//         <input type="date" name="checkOut" value={formData.checkOut} onChange={handleChange} className="w-full border px-3 py-2 rounded" />
//       </div>
//       <div className="mb-4">
//         <label>Email:</label>
...
//       <div className="mb-4">
//         <label>Phone:</label>
//         <input type="text" name="phone" value={formData.phone} onChange={handleChange} className="w-full border px-3 py-2 rounded" placeholder="Enter 10-digit phone number" />
//       </div>

//       <div className="mb-4">
//         <label className="font-semibold mr-2">Payment Method:</label>
//         <select name="paymentMethod" value={formData.paymentMethod} onChange={handleChange} className="border rounded px-3 py-2">
...
//       <button onClick={handleBooking} className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold shadow">
//         Confirm Booking
//       </button>

//       {statusMessage && <p className="mt-4 text-center text-green-700 font-medium">{statusMessage}</p>}
//     </div>
//   );
// };
...
//     const plates = Number(formData.plates || 0);
//     const price = Number(formData.pricePerPlate || 0);
//     return plates * price * calculateDays(); // 🟢 Updated to multiply with days
//   };
