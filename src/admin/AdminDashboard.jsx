...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-row w-full">
      {/* Sidebar */}
      <AdminSidebar />
      {/* Main Content */}
      <motion.main
        className="flex-grow p-4 sm:p-6 w-full transition-all duration-300 min-h-screen flex flex-col"
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
        {/* ✅ Room Booking Blocked Dates */}
        <motion.div
          className="bg-white p-4 sm:p-6 md:p-8 rounded-2xl shadow-xl border border-gray-200"
          variants={sectionVariants}
          initial="hidden"
          animate="visible"
        >
          <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-700 mb-4 text-center">
            Room Bookings
          </h3>
          <AdminBlockedDates type="Room" />
        </motion.div>

        {/* ✅ Lawn Booking Blocked Dates */}
        <motion.div
          className="bg-white p-4 sm:p-6 md:p-8 rounded-2xl shadow-xl border border-gray-200"
          variants={sectionVariants}
          initial="hidden"
...
//             { to: "/admin/room-management", label: "Room Management" },
//           ].map((link) => (
//             <motion.div
//               key={link.to}
//               whileHover="hover"
