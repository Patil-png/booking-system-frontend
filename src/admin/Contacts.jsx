...
const Contacts = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-row bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50">
        <AdminSidebar />
    ...
    <div className="min-h-screen flex flex-row bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50">
      ...
      <div className="flex-grow py-6 px-2 sm:px-6 lg:px-8 w-full">
        ...
        >
          ...
          {/* Main Content */}
          <motion.div
            className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-white/20 p-2 sm:p-6"
            variants={itemVariants}
          >
            {/* Modern Table */}
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-gray-700">
                <thead className="bg-gradient-to-r from-purple-600 to-indigo-700 text-white">
                  ...
                  >
                    <th className="px-4 py-4 rounded-tl-2xl">Name</th>
                    <th className="px-4 py-4">Email</th>
                    <th className="px-4 py-4 hidden md:table-cell">Phone</th>
                    <th className="px-4 py-4 hidden lg:table-cell">Inquiry</th>
                    <th className="px-4 py-4">Message</th>
                    <th className="px-4 py-4 hidden sm:table-cell">Date</th>
                    <th className="px-4 py-4 rounded-tr-2xl">Actions</th>
                  </motion.tr>
                </thead>
                  ...
                  <AnimatePresence>
                    {contacts.length > 0 ? (
                      contacts.map((c, index) => (
                        <motion.tr
                          key={c._id}
                          className="hover:bg-gradient-to-r hover:from-purple-50 hover:to-indigo-50 transition-all duration-200 rounded-xl"
                        ...
                        >
                          ...
                          <td className="px-4 py-4 max-w-[120px] truncate">{c.email}</td>
                          <td className="px-4 py-4 hidden md:table-cell">{c.phone || "N/A"}</td>
                          <td className="px-4 py-4 hidden lg:table-cell">{c.inquiryType || "N/A"}</td>
                          <td className="px-4 py-4 max-w-[160px] truncate">{c.message}</td>
                          ...
                          <td className="px-4 py-4 text-right">
                            <div className="flex flex-col sm:flex-row items-center gap-2">
                              <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-xs sm:text-sm font-medium transition-all duration-200 flex items-center space-x-1 shadow-md hover:shadow-lg ${
                                  replyingTo === c._id
                              ...
                              <button
                                ...
                                className="px-3 py-1.5 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg text-xs sm:text-sm font-medium hover:from-red-600 hover:to-red-700 transition-all duration-200 shadow-md hover:shadow-lg"
                              >
                                Delete
                              </button>
                            </div>
                            ...
                            <AnimatePresence>
                              {replyingTo === c._id && (
                                <motion.div
                                  ...
                                  className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl shadow-inner border border-blue-200 overflow-hidden mt-2"
                                >
